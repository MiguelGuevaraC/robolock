...
$(document).ready(function () {
    ...
    // =================================================================
    //     $("#btnModalRegistroGrupoMenu").on("click", function () {
    //         var csrfToken = "1";
    //         bootbox.dialog({
    //             title: "Registro Grupo de Menu",
    //             message:
    //                 '<div class="row">' +
    //                 '   <div class="col-md-12">' +
    //                 '       <form id="registroEditarGrupoMenu" class="form-horizontal">' +
    //                 "           @csrf" +
    //                 '           <div class="form-group">' +
    //                 '               <label class="col-md-2 control-label" for="nombre">Nombre</label>' +
    //                 '               <div class="col-md-8">' +
    //                 '                   <input id="nombre" name="nombre" type="text" placeholder="Escribe aquí..." class="form-control">' +
    //                 "               </div>" +
    //                 "           </div>" +
    //                 '           <div class="form-group">' +
    //                 '               <label class="col-md-2 control-label" for="icono">Icono</label>' +
    //                 '               <div class="col-md-8">' +
    //                 '                   <input id="icono" name="icono" type="text" placeholder="Escribe aquí..." class="form-control">' +
    //                 "               </div>" +
    //                 "           </div>" +
    //                 "       </form>" +
    //                 "   </div>" +
    ...
    //                         $("#registroEditarGrupoMenu").html($("#registroEditarGrupoMenu").html()+'@scrf');
    // console.log($("#registroEditarGrupoMenu").html());
    //                         var formData = new FormData(
    //                             $("#registroEditarGrupoMenu")[0]
    //                         );
    //                         formData.append("nameGrupoOpcion", "nameGrupoOpcion");
    //                         formData.append("iconoGrupoOpcion", "iconoGrupoOpcion");
    ...
    //                                     $("#tbCategoriaMenu")
    //                                         .DataTable()
    //                                         .ajax.reload(); //recargar datatable
    //                                     $(".demo-modal-radio").niftyCheck();
    //                                 } else {
    //                                     alert("nO");
    //                                 }
    ...
    $("#demo-bootbox-bounce").on("click", function () {
        bootbox.confirm({
            message:
                "<p class='text-semibold text-main'>Bounce</p><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>",
            buttons: {
                confirm: {
                    label: "Save",
                },
    ...
    $("#demo-bootbox-ruberwobble").on("click", function () {
        bootbox.confirm({
            message:
                "<p class='text-semibold text-main'>RubberBand & Wobble</p><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>",
            buttons: {
                confirm: {
                    label: "Save",
                },
    ...
    $("#demo-bootbox-flip").on("click", function () {
        bootbox.confirm({
            message:
                "<p class='text-semibold text-main'>Flip</p><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>",
            buttons: {
                confirm: {
                    label: "Save",
                },
    ...
    $("#demo-bootbox-lightspeed").on("click", function () {
        bootbox.confirm({
            message:
                "<p class='text-semibold text-main'>Light Speed</p><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>",
            buttons: {
                confirm: {
                    label: "Save",
                },
    ...
    $("#demo-bootbox-swing").on("click", function () {
        bootbox.confirm({
            message:
                "<p class='text-semibold text-main'>Swing & Hinge</p><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>",
            buttons: {
                confirm: {
                    label: "Save",
                },
