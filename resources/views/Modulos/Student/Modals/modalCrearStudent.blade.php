<style>/* Estilos generales para el modal */
    .modal-header {
            ...
            <div class="modal-body">
                <form id="registroPersona" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-4">
                                <label for="numberIdentity" class="form-label">N° IDENTIDAD:</label>
                                <input type="text" class="form-control" name="numberIdentity" id="numberIdentity" placeholder="Ingrese el número de identidad" required>
                            </div>
                            <div class="form-group mb-4">
                                <label for="names" class="form-label">Nombres:</label>
                                <input type="text" class="form-control" name="names" id="names" placeholder="Ingrese los nombres completos" required>
                            </div>
                            <div class="form-group mb-4">
                                <label for="fatherSurname" class="form-label">Apellido Paterno:</label>
                                <input type="text" class="form-control" name="fatherSurname" id="fatherSurname" placeholder="Ingrese el apellido paterno" required>
                            </div>
                            <div class="form-group mb-4">
                                <label for="motherSurname" class="form-label">Apellido Materno:</label>
                                <input type="text" class="form-control" name="motherSurname" id="motherSurname" placeholder="Ingrese el apellido materno" required>
                            </div>
                            <div class="form-group mb-4">
                                <label for="dateOfBirth" class="form-label">Fecha de Nacimiento:</label>
                                <input type="date" class="form-control" name="dateOfBirth" id="dateOfBirth" placeholder="Seleccione la fecha de nacimiento" required>
                            </div>
                            <div class="form-group mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control" name="UID" id="uid" placeholder="Ingrese el UID" required>
                            </div>
                            <div class="form-group mb-4">
                                <label for="photoUpload" class="form-label">Subir Imágenes (JPG, PNG):</label>
                                <input type="file" class="form-control" id="photoUpload" name="photoUpload[]" accept="image/jpeg, image/png" multiple>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <button type="button" id="captureBtn" class="btn btn-primary mb-2" style="display: none;">Tomar Foto</button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-4 text-center">
                                ...
                                <div id="capturedPhotos" class="overflow-auto" style="max-height: 500px; overflow-y: auto; border: 1px solid #ccc; padding: 10px;">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark m-2" data-dismiss="modal" tabindex="3">Cancelar</button>
